-- Fix the handle_new_user trigger to include username in the INSERT
-- and make username nullable to prevent signup failures
ALTER TABLE public.profiles ALTER COLUMN username DROP NOT NULL;

-- Also update the trigger function to always provide a username fallback
