...
export const HOOK_TOUR: TourDefinition = {
  ...
  intro: {
    ...
    script: `Good evening. I'm Reginald, your concierge at the Phototheology Palace. I'm going to take exactly three minutes to show you something that will change how you read the Bible — permanently. Here's the problem. You've read Psalm 23 a hundred times. "The LORD is my shepherd, I shall not want." You know the words. But be honest — when's the last time those words actually moved you? When's the last time a familiar passage made your heart race with a discovery you'd never seen before? If the Bible has started feeling flat, it's not the Bible's fault. And it's definitely not yours. You were just never given a method for seeing what's really there.`,
    estimatedSeconds: 35,
  },
  segments: [
    {
  ...
  outro: {
    ...
    script: `That was one psalm, and we barely scratched the surface. In the full Psalm 23 Palace Tour, Jeeves and I walk you through every room in the palace — showing you how each principle reveals something new in those six verses. By the end, Psalm 23 won't just be a comforting poem anymore. It'll be a theological cathedral you built with your own mind. If you're ready, select the Psalm 23 Guided Tour and let's go deeper. You're about to discover that the Bible was never boring — you just needed the right eyes. See you inside.`,
    estimatedSeconds: 25,
  },
};
