    ...
    rooms: [
      {
        ...
        tag: "CR",
        action: "Apply one of Christ's three offices (Prophet, Priest, or King) to your passage and identify His specific title, act, and benefit.",
        output: "CR tag: Office (Prophet/Priest/King) → Title → Act → Benefit to believers (1 sentence each).",
        estimatedTime: "standard",
        quickMode: [
          "Read the passage and identify Christ's primary activity (teaching? sacrificing? ruling?)",
          "Tag the office: Prophet (reveals), Priest (mediates), or King (rules)",
          "Name the specific title or role Christ holds here",
          "State what He accomplishes and how it benefits believers"
        ],
        ...
        coreQuestion: "Apply one of Christ's three offices (Prophet, Priest, or King) to this passage. How does this office shape your interpretation and application?",
      ...
      },
      {
        ...
        tag: "DR",
        action: "Write 1-2 sentences for each of the five dimensions: Literal, Christological, Personal, Ecclesiological, and Eschatological/Heavenly.",
        output: "DR worksheet: 5 dimensions × 1-2 sentences each. Each dimension offers a distinct insight—no repeating the same idea.",
        estimatedTime: "standard",
        quickMode: [
          "LITERAL: What actually happened in the original context?",
          "CHRIST: How does this text reveal or foreshadow Jesus?",
          "PERSONAL: How does this apply to my walk with God today?",
          "CHURCH: What does this teach the body of believers corporately?",
          "HEAVEN: How does this point to eternity and the new creation?"
        ],
      ...
      },
      {
        ...
        name: "Connect-6",
        tag: "C6",
        action: "Connect your passage to all six biblical genres (Prophecy, Parable, Epistle, History, Gospel, Poetry) OR unify one verse from each genre around a single theme.",
        output: "C6 note: Either Single-Text Mode (1 passage → 6 genre connections + synthesis) or Multi-Text Mode (1 theme → 6 verses + convergence paragraph).",
        estimatedTime: "extended",
        quickMode: [
          "Choose Mode 1 (single text across genres) or Mode 2 (one theme, six genre verses)",
          "For each genre, find a supporting or parallel text with verse reference",
          "Write one connection sentence per genre explaining how it illuminates the truth",
          "Synthesize: How do all six voices together deepen your understanding?"
        ],
      ...
      },
      {
        ...
        name: "Theme Room",
        tag: "TRm",
        action: "Identify which of the six theological spans your passage occupies: Sanctuary, Life of Christ, Great Controversy, Time-Prophecy, Gospel Floor, or Heaven Ceiling.",
        output: "TRm tag: Primary span name → 1-2 sentence rationale explaining why it fits. Optional secondary span if the text bridges two.",
        estimatedTime: "standard",
        quickMode: [
          "Read the passage and identify its major theological focus",
          "Match it to one of the six spans (Sanctuary, Life of Christ, Great Controversy, Time-Prophecy, Gospel, Heaven)",
          "Write 1-2 sentences explaining why this span fits",
          "Note connections to other texts on the same span"
        ],
        ...
        coreQuestion: "Apply one of the six theological spans to this passage: Sanctuary, Life of Christ, Great Controversy, Time-Prophecy, Gospel Floor, or Heaven Ceiling. Explain how this span illuminates the text.",
      ...
      },
      {
        ...
        name: "Time Zone",
        tag: "TZ",
        action: "Choose a specific time zone (Heaven-Past, Heaven-Present, Heaven-Future, Earth-Past, Earth-Present, or Earth-Future) and explain how the text speaks within that context.",
        output: "TZ tag: Time zone name → 2-3 sentences explaining how the passage speaks through that temporal-spatial lens.",
        estimatedTime: "standard",
        quickMode: [
          "Read the passage you're studying",
          "Select one specific time zone to explore (e.g., Heaven-Past, Earth-Present)",
          "Explain how the text speaks within that chosen zone's context",
          "Optionally explore additional zones for richer insight"
        ],
      ...
      },
      {
        ...
        name: "Patterns Room",
        tag: "PRm",
        action: "Identify a recurring biblical motif that appears 3+ times across Scripture, name it, list examples, and extract the theological lesson.",
        output: "Pattern Card: Pattern name → Structure (1-2 sentences) → 3+ examples with references → Theological insight.",
        estimatedTime: "extended",
        quickMode: [
          "Notice a repeated action, theme, or structure in your study",
          "Search for at least 3 clear instances across different books/eras",
          "Name the pattern with a memorable label (e.g., 'Wilderness Testing')",
          "Extract the theological lesson: What does this pattern reveal about God?"
        ],
      ...
      },
      {
        ...
        name: "Parallels Room",
        tag: "P‖",
        action: "Place two biblical events side by side (usually OT and NT), map what echoes and what escalates, and extract the theological lesson.",
        output: "Parallel comparison: Event A ↔ Event B → What echoes (similarities) → What escalates (NT surpasses OT) → Lesson (1-2 sentences).",
        estimatedTime: "standard",
        quickMode: [
          "Identify two events that share structural DNA (usually one OT, one NT)",
          "Describe both events briefly (1 sentence each)",
          "Map what ECHOES (what's similar) and what ESCALATES (what's greater in the second event)",
          "Extract the theological lesson: Why did God mirror this action?"
        ],
      ...
      },
      {
        ...
        name: "Fruit Room",
        tag: "FRt",
        action: "State your interpretation, check what fruit it produces (humility or pride? faith or fear? love or judgmentalism?), and revise if the fruit is toxic.",
        output: "Fruit check: Your interpretation (1-2 sentences) → Fruit produced (good or bad?) → If bad, revision + re-check → Final verdict.",
        estimatedTime: "standard",
        quickMode: [
          "State your interpretation of the passage clearly (1-2 sentences)",
          "Ask: What does this interpretation produce in me? (humility/pride, faith/fear, love/judgment)",
          "Name the fruit—is it Christlike or toxic?",
          "If bad fruit, revise until the interpretation produces good fruit"
        ],
    ...
    rooms: [
      {
        ...
        action: "Map your passage to a specific sanctuary article (altar, laver, lampstand, table, incense altar, veil, ark), service (daily or Day of Atonement), or location (courtyard, Holy Place, Most Holy Place)—then show how Christ fulfills it.",
        output: "BL tag: Article/Service/Location → Christ's Fulfillment (1 sentence) → Doctrinal Theme → NT Crosslink (1-2 refs).",
        coreQuestion: "Connect this passage to a specific sanctuary article, service, or location (altar, laver, lampstand, table, incense altar, veil, ark, mercy seat). How does it reveal Christ's heavenly ministry?",
        estimatedTime: "standard",
        quickMode: [
          "Read the passage and identify the sanctuary element (furniture, service, or location)",
          "Map it: Which article or spatial zone does this connect to?",
          "State Christ's fulfillment: What does He DO in this role?",
          "Find 1-2 NT crosslinks that explicitly tie this sanctuary element to Christ"
        ],
      ...
      },
      {
        ...
        name: "Prophecy Room",
        tag: "PR",
        action: "Identify the prophetic symbol in your passage, place it on the historicist timeline (Babylon → Rome → End Times), and align with parallel Daniel-Revelation visions.",
        output: "PR Map: Symbol → Historical ID (with dates) → Parallel vision(s) → Time period (if applicable) → Future horizon.",
        estimatedTime: "extended",
        quickMode: [
          "Identify the prophetic symbol (beast, horn, woman, time period, etc.)",
          "Place it on the historicist timeline: Which kingdom or era?",
          "Align with parallel visions in Daniel-Revelation covering the same period",
          "State the historical fulfillment and any future application"
        ],
      ...
      },
      {
        ...
        tag: "3A",
        action: "Connect your passage to one or more of the Three Angels' Messages (Rev 14:6-12): everlasting gospel, creation worship, judgment, Babylon's fall, or end-time faithfulness.",
        output: "3A Connection: Angel # (1st/2nd/3rd) → How passage connects (1-2 sentences) → Mission application.",
        estimatedTime: "standard",
        quickMode: [
          "Review the three angels: 1st (gospel, worship Creator, judgment), 2nd (Babylon fallen), 3rd (beast/mark warning, patient endurance)",
          "Identify which angel(s) your passage connects to",
          "State the connection explicitly in 1-2 sentences",
          "Apply: How does this truth need to be proclaimed today?"
        ],
      ...
      },
      {
        ...
        name: "Feasts Room",
        tag: "FE",
        action: "Connect your passage to one of the seven feasts (Passover, Unleavened Bread, Firstfruits, Pentecost, Trumpets, Atonement, Tabernacles) and show how Christ fulfills it.",
        output: "Feast note: Feast name → OT ritual (brief) → Christ's fulfillment (1 sentence) → Timeline status (Fulfilled/In Progress/Awaiting) → Application.",
        estimatedTime: "standard",
        quickMode: [
          "Identify which feast your passage connects to (blood/deliverance = Passover, resurrection = Firstfruits, judgment = Atonement, etc.)",
          "Describe the original OT feast ritual briefly",
          "State how Christ fulfills it",
          "Mark timeline: Fulfilled (1st Coming), In Progress (judgment), or Awaiting (2nd Coming)"
        ],
        ...
        coreQuestion: "Connect this passage to one of the seven feasts (Passover, Unleavened Bread, Firstfruits, Pentecost, Trumpets, Atonement, Tabernacles). How does it reveal Christ's redemptive timeline?",
      ...
      },
      {
        ...
        tag: "CEC",
        action: "Use the 5 'Finding Waldo' methods (Promise, Type, Gospel Trail, God's Heart, Unfinished Story) to find Christ in your chapter—name His title, action, and NT crosslink.",
        output: "CEC Note: Methods used → Christ's Name/Role → Christ's Action → 1-2 NT crosslink verses confirming the connection.",
        estimatedTime: "standard",
        quickMode: [
          "Apply all 5 methods: Any promise of a Redeemer? Any type/shadow? Any rescue pattern? What does God's character reveal? What's unfinished?",
          "Name Christ's title or role in this chapter (Lamb, King, Shepherd, etc.)",
          "State what He does here (atones, delivers, reveals, intercedes, etc.)",
          "Find 1-2 NT verses that confirm the Christ-connection"
        ],
      ...
      },
      {
        ...
        name: "Room 66",
        tag: "R66",
        action: "Choose a single theme (e.g., The Lamb, The Seed, The Kingdom) and trace it through multiple Bible books, building a grid of claims and proof-texts plus a 100-120 word constellation summary.",
        output: "R66 grid: Book name → Claim (≤14 words) → Proof-text → Tags. Plus a Constellation Summary (100-120 words) showing the theme's arc from Genesis to Revelation.",
        estimatedTime: "extended",
        quickMode: [
          "Choose a theme that spans the Bible (Lamb, Seed, Kingdom, Temple, Covenant, etc.)",
          "For each book, write a ≤14-word claim + proof-text showing how the theme appears",
          "Maintain progressive revelation: show how the theme starts, develops, climaxes in Christ, and consummates in Revelation",
          "Write a 100-120 word Constellation summarizing the theme's full biblical arc"
        ],
    ...
    rooms: [
      {
        ...
        name: "Three Heavens",
        tag: "1H/2H/3H",
        action: "Assign your passage a horizon tag—1H (historical fulfillment), 2H (church-age/spiritual fulfillment), or 3H (eschatological/eternal fulfillment)—and explain why.",
        output: "Horizon tag: 1H/2H/3H → 1-2 sentences explaining which fulfillment layer applies and how the text speaks at that level.",
        estimatedTime: "standard",
        quickMode: [
          "Read the passage and ask: When is this fulfilled?",
          "Tag the horizon: 1H (already happened in history), 2H (happening now in the church age), or 3H (ultimate eschatological fulfillment)",
          "Explain why this horizon fits in 1-2 sentences",
          "Note if the passage has multiple horizons (many texts speak at 2-3 levels simultaneously)"
        ],
        ...
        coreQuestion: "Apply one of the Three Heavens horizons to this prophecy: 1H (Babylon/return), 2H (AD 70/church age), or 3H (final judgment/new creation). Identify textual markers that support your reading.",
      ...
      },
      {
        ...
        name: "Eight Cycles",
        tag: "@",
        action: "Identify which covenant cycle your passage belongs to (@Ad, @No, @Ab, @Mo, @CyC, @Sp, @Xp, @NC) and locate its position in the 5-beat arc: Fall → Covenant → Sanctuary → Enemy → Restoration.",
        output: "Cycle note: Cycle tag (e.g., @Mo) → Position in the 5-beat arc → One comparison with a similar element from a different cycle.",
        estimatedTime: "standard",
        quickMode: [
          "Identify the covenant cycle: Which era does this passage belong to? (Adam, Noah, Abraham, Moses, etc.)",
          "Locate its position in the 5-beat arc: Fall, Covenant, Sanctuary, Enemy, or Restoration?",
          "Tag it with the cycle code (e.g., @Mo for Mosaic)",
          "Compare: Find a parallel element in a different cycle to show the pattern"
        ],
        ...
        coreQuestion: "Place this text within one of the 8 redemptive cycles (Adamic, Noahic, Abrahamic, Mosaic, Cyrusic, Christ, Spirit, Remnant). What covenant responsibility does this cycle reveal?",
      ...
      },
      {
        ...
        name: "Juice Room",
        tag: "JR",
        action: "Extract maximum meaning at the chosen scale: Micro (verse → 5 layers of juice), Meso (chapter → core message + structure), or Macro (book → 150-word synthesis + one-sentence tag).",
        output: "Juice Summary (150 words or less) flowing through story, Christ, genre, cycle, and horizon—plus a Final Tag Line capturing the book's essence in one sentence.",
        estimatedTime: "extended",
        quickMode: [
          "Choose your juicing mode: Micro (verse), Meso (chapter), or Macro (book)",
          "Extract every legitimate layer of meaning without importing ideas not in the text",
          "Synthesize into a flowing narrative (not a checklist): story, Christ, genre, cycle, horizon",
          "Write a punchy Final Tag Line capturing the essence"
        ],
      ...
      },
      {
        ...
        tag: "MATH",
        action: "Apply one of the six prophetic time structures (@120, @400, @70y, @490, @1260, or @2300) to your passage and explain the connection with a WHY, BOUNDARY, and LIMITATION.",
        output: "Time-prophecy note: Prophecy code → Core meaning of that timeline → How the text connects → Boundaries/limitations → Theological lesson.",
        estimatedTime: "standard",
        quickMode: [
          "Identify which time prophecy your passage connects to (@120, @400, @70y, @490, @1260, @2300)",
          "State the core meaning of that prophetic timeline",
          "Explain HOW the text connects—point to textual markers",
          "Include a WHY (reasoning), BOUNDARY (scope), and LIMITATION (what this mapping does NOT claim)"
        ],
        ...
        coreQuestion: "Apply one of the six prophetic time structures (@120, @400, @70y, @490, @1260, or @2300) to this text. Show how God works through TIME itself in this passage.",
    ...
    rooms: [
      {
        ...
        name: "Fire Room",
        tag: "FRm",
        action: "Read meditatively, name the wound (conviction) or hope (comfort) the text stirs in your soul, then pray it back to God in a specific, personal prayer.",
        output: "Fire Record (2-3 sentences): The wound or hope the text exposed → Your brief prayer response → One sentence capturing the encounter.",
        estimatedTime: "standard",
        quickMode: [
          "Read slowly and meditatively—savor each phrase",
          "Ask: What is this stirring in me? Name the wound (sin exposed) or hope (promise offered)",
          "Be specific, not vague—name the exact conviction or comfort",
          "Pray it back to God: confess, repent, thank, or worship based on what the text stirred"
        ],
      ...
      },
      {
        ...
        tag: "MR",
        action: "Select a small portion (1 verse or phrase), read it phrase by phrase, breathe and pray with it, repeat 10-20 times, then journal the one truth you'll carry today.",
        output: "Meditation Line (1-2 sentences): The verse/phrase meditated on → The ONE truth you'll carry today → How you'll return to it throughout the day.",
        estimatedTime: "standard",
        quickMode: [
          "Select a small portion: 1 verse or even a single phrase (5-15 words)",
          "Read phrase by phrase, lingering 30-60 seconds on each word",
          "Breathe and pray with it: inhale the first half, exhale the second half",
          "Repeat 10-20 times, then write the ONE truth you'll carry today"
        ],
      ...
      },
      {
        ...
        name: "Speed Room",
        tag: "SRm",
        action: "Choose a sprint type (Christ-link, verse location, typology, timeline, or doctrine sprint), set a timer, execute under pressure, then score yourself and identify weak spots.",
        output: "Sprint report: Sprint type → Target (e.g., '10 answers in 2 min') → Results and score → Weak spots to drill later.",
        estimatedTime: "quick",
        quickMode: [
          "Choose a sprint type: Christ-links, verse locations, typologies, timelines, or doctrine recall",
          "Set a timer (start generous, reduce as you improve)",
          "Execute: write or speak answers as fast as you can—no looking up verses",
          "Score yourself on accuracy, completeness, and speed. Note weak spots to drill"
        ],
    ...
    rooms: [
      {
        ...
        tag: "∞",
        action: "Teach or preach a passage naturally (no Palace terminology), then audit yourself: which rooms did you use unconsciously? Which did you skip?",
        output: "Three parts: 1) Your natural teaching outline, 2) Post-audit listing rooms used unconsciously, 3) Gap analysis—rooms skipped and why.",
        estimatedTime: "extended",
        quickMode: [
          "Choose a passage you haven't formally studied and teach it naturally—no Palace jargon",
          "Record or write your teaching outline",
          "Post-audit: Tag which rooms you used without thinking (SR? CR? DR? FRt?)",
          "Identify gaps: Which rooms did you skip? Those reveal where instincts need strengthening"
        ],
        icon: "Infinity",
      ...
      },
      {
        ...
        tag: "PFS",
        action: "Think out loud with Scripture—share emerging patterns, test cross-room echoes, and explore unresolved threads. Use exit commands to crystallize discoveries.",
        output: "Three parts: 1) Your exploration (thinking-out-loud conversation), 2) Gems—insights worth crystallizing, 3) Room tags—which Palace principles were at work.",
        estimatedTime: "extended",
        quickMode: [
          "Share what you're noticing in Scripture—think out loud without fear of being wrong",
          "Look for emerging patterns and cross-room echoes across texts",
          "When ready, stabilize insights: 'Make a Gem,' 'Which Room?,' or 'Is This Safe?'",
          "Tag which Palace rooms were at work in your exploration"
        ],
        icon: "Sparkles",
