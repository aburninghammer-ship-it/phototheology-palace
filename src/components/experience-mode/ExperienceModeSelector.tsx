...
const MODE_OPTIONS: ModeOption[] = [
  {
    ...
    description: "AI Bible assistant, Study Bible with 8 audio voices, Chapel devotionals, My Church & Community.",
    icon: Zap,
  ...
  },
  {
    ...
    description: "Everything in Basic plus the 8-Floor Palace, Games & Challenges, University courses, and guided coaching.",
    icon: Compass,
  ...
  },
  {
    ...
    description: "Everything in Explorer plus Sermon Prep, Apologetics & Debate, VR Palace, Train, and full Mastery tools.",
    icon: Flame,
