...
const AMBIENT_TRACKS = [
  ...
  },
  {
    ...
    category: "floor-4",
    floor: 4,
    mood: "cinematic, sweeping, reverent",
  ...
  },
  {
    ...
    category: "floor-4",
    floor: 4,
    mood: "cinematic, instrumental, reverent",
  ...
  },
  {
    ...
    category: "floor-4",
    floor: 4,
    mood: "cinematic, eternal, orchestral",
  ...
  // Additional ambient tracks
  {
    ...
    description: "Peaceful meditative piano and strings",
    category: "floor-3",
    floor: 3,
  ...
  },
  {
    ...
    description: "Atmospheric ambient orchestral",
    category: "floor-3",
    floor: 3,
  ...
  },
  {
    id: "amazing-grace",
    name: "Amazing Grace",
    description: "Classic hymn arrangement with orchestral strings",
    category: "floor-4",
    floor: 4,
    mood: "classic, hymn, reverent",
  ...
  },
  {
    id: "dark-times",
    name: "Dark Times",
    description: "Dramatic orchestral for prophetic themes",
    category: "floor-5",
    floor: 5,
    mood: "dramatic, prophetic",
    url: "https://incompetech.com/music/royalty-free/mp3-royaltyfree/Dark%20Times.mp3",
    bpm: 60,
  },
  {
    id: "meditation-aquatic",
    name: "Meditation Aquatic",
    description: "Flowing water-inspired ambient music",
    category: "floor-6",
    floor: 6,
    mood: "flowing, aquatic, peaceful",
  ...
  },
  {
    id: "perspectives",
    name: "Perspectives",
    description: "Thoughtful orchestral for deep study",
    category: "floor-7",
    floor: 7,
    mood: "thoughtful, deep, contemplative",
