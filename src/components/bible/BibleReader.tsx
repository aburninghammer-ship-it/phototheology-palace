    ...
    return (
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        {(() => {
          ...
          return (
            <div className="lg:col-span-1 space-y-4 lg:space-y-6 lg:sticky lg:top-20 lg:self-start lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto scrollbar-thin" ref={jeevesRef}>
