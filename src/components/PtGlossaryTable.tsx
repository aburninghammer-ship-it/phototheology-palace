...
const GLOSSARY: GlossaryEntry[] = [
  ...
  { term: "Phototheology Studio", category: "floor", icon: Palette, definition: "OS Space for Bible study, research, and reference tools — the Study Bible, lexicon, encyclopedia, timeline, and research assistants." },
  { term: "Phototheology Gallery", category: "floor", icon: Building2, definition: "OS Space for the Memory Palace, visual mapping, mind maps, image Bible, VR experience, and memory training exercises." },
  { term: "Phototheology Stage", category: "floor", icon: Mic, definition: "OS Space for sermon building, teaching output, amplifying studies with cross-references, remixing content, and video training resources." },
  { term: "Phototheology Arena", category: "floor", icon: Swords, definition: "OS Space for games, challenges, COTA, Defense Mode, AATS, apologetics, leaderboard, and competitive theological training." },
  { term: "Phototheology Chapel", category: "floor", icon: Church, definition: "OS Space for devotionals, reading plans, church community, prayer, grief support, marriage resources, and wellness guides." },
  { term: "Phototheology Workshop", category: "floor", icon: Wrench, definition: "OS Space for AI tools (PT GPT, Kid GPT, Daniel & Rev GPT), workspace settings, and study partner connections." },
  { term: "Phototheology Academy", category: "floor", icon: GraduationCap, definition: "OS Space for structured courses — PT Course, Blueprint, Daniel, Revelation — plus floor mastery tracking and earned certificates." },
