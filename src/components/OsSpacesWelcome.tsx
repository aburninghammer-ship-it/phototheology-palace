...
const OS_SPACES: OsSpace[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Community", path: "/community", icon: Users, description: "Study partners", tooltip: "Find and connect with other Phototheologists. Join study groups, share insights, and grow together." },
      { label: "My Profile", path: "/my-profile", icon: User, description: "Your profile", tooltip: "View and customize your Phototheologist profile. Track your stats, study streaks, and floor progress." },
