...
export const DonationBanner = () => {
  ...
  return (
    <>
      ...
      <div
        ref={bannerRef}
        className="fixed top-0 left-0 right-0 z-[60] pt-[env(safe-area-inset-top,0px)] pb-1 sm:pb-2 px-3 sm:px-4 bg-gradient-to-r from-primary/80 via-primary/90 to-primary/80 border-b-2 border-primary-foreground/30"
        style={{
