...
export default function BlueprintWeightLoss() {
  ...
  const handleComplete = (articleId: number) => {
    ...
    toast({
      ...
      description: t('common.articleCompleted', { name: WEIGHT_LOSS_ARTICLES.find(a => a.id === articleId)?.name }),
    });
  };
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        {!selectedArticle ? (
          <>
            <section className="text-center space-y-4">
              ...
              <div className="flex justify-center">
                <EnhancedSocialShare
                  title={t('blueprint.weightLoss.shareTitle')}
                  content={t('blueprint.weightLoss.shareContent')}
                  url={window.location.href}
                  defaultMessage={t('blueprint.weightLoss.shareDefaultMessage')}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                    <h3 className="font-semibold text-lg mb-2 flex items-center gap-2">
                      ...
                      {t('blueprint.weightLoss.weightLossPrinciple')}
                    </h3>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg">
                    <h3 className="font-semibold text-lg mb-3">{t('blueprint.weightLoss.biblicalFoundation')}</h3>
                    <div className="prose prose-sm max-w-none">
                  ...
                  <div className="bg-green-50 dark:bg-green-950 p-4 rounded-lg">
                    <h3 className="font-semibold text-lg mb-3">{t('blueprint.weightLoss.practicalSteps')}</h3>
                  ...
                  <div className="bg-orange-50 dark:bg-orange-950 p-4 rounded-lg">
                    <h3 className="font-semibold text-lg mb-2">{t('blueprint.weightLoss.sevenDayChallenge')}</h3>
                  ...
                  <div className="space-y-3">
                    <h3 className="font-semibold text-lg">{t('blueprint.weightLoss.yourNotesAndProgress')}</h3>
                    <Textarea
                      placeholder={t('blueprint.weightLoss.notesPlaceholder')}
          ...
          <BlueprintEnhancedFeatures
            ...
            dailyCheckItems={[
              t('blueprint.weightLoss.dailyCheck.drankWater'),
              t('blueprint.weightLoss.dailyCheck.healthyFood'),
              t('blueprint.weightLoss.dailyCheck.physicalActivity'),
              t('blueprint.weightLoss.dailyCheck.readArticle'),
              t('blueprint.weightLoss.dailyCheck.prayedHealth'),
              t('blueprint.weightLoss.dailyCheck.avoidedEmotionalEating')
            ]}
          />
          </>
        )}
